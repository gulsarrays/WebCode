...
//          $databaseConnection = $this->configureConnectionByName(getTenantDBName(Auth::user()->account_id));
            ...
            Artisan::call('migrate', array('--database' => $web_app_tenant_db, '--path' => '/database/migrations/2018_04_30_073217_create_products_table.php', '--verbose' => 'vvv'));

            // Add user DB details in main DB
...
//        return DB::statement("CREATE DATABASE :schema", array('schema' => $schemaName));
        return DB::statement("CREATE DATABASE IF NOT EXISTS $schemaName");
    }
